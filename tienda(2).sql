...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2025 a las 05:26:03
...
INSERT INTO `clientes` (`id_cliente`, `nombre`, `telefono`, `email`, `documento_identidad`, `limite_credito`, `fecha_registro`, `apellido`) VALUES
(4, 'sara', '1234567890', 'cfajardosossa@gmail.com', '1027401784', 50.00, '2025-07-07', 'zanabria'),
(5, 'camilo cifuentes', '1234567890', 'sebastian040522@gmail.com', '1027401744', 50.00, '2025-07-07', 'zanabria');
...
INSERT INTO `usuarios` (`id_usu`, `nombre`, `contrasena`, `email`, `activo`) VALUES
(1, 'sebastian bernal holguin', '123456', 'sebas@gmail.com', 1);
...
ALTER TABLE `usuario_rol`
  ...
  ADD KEY `FK_usuario_rol_usuario_id` (`usuario_id`),
...
--
ALTER TABLE `usuario_rol`
  ADD CONSTRAINT `FK_usuario_rol_rol_id` FOREIGN KEY (`rol_id`) REFERENCES `roles` (`id_rol`),
  ADD CONSTRAINT `FK_usuario_rol_usuario_id` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usu`);
